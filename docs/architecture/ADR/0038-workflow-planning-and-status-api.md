...
- **Consequences:** Clients can validate engine choice and monitor persisted task states. Submission returns immediately while the local supervisor owns execution. Lease expiry requeues work, but engine task recovery remains handler-owned. Active-child cancellation and bounded artifact uploads remain follow-up work.
